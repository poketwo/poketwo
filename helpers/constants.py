...
BOT_MANAGER_ROLES = (*ADMIN_ROLES, 1219501453240959006)
SERVER_MANAGER_ROLES = (*ADMIN_ROLES, 1219500880534179892)
MODERATOR_ROLES = (*BOT_MANAGER_ROLES, *SERVER_MANAGER_ROLES, 724879492622843944, 930346843521556540)
...
GENDER_EMOTES = {
    ...
    "unknown": "<:unknown:1207995667788726272>",
}
