...
class ConfirmationView(discord.ui.View):
    def __init__(self, ctx: PoketwoContext, *, timeout: int, delete_after: bool, delete_after_timeout: bool) -> None:
        super().__init__(timeout=timeout)
        self.result = None
        self.ctx = ctx
        self.message = None
...
class RequestView(ConfirmationView):
    def __init__(self, *args, requestee: typing.Union[discord.User, discord.Member], **kwargs) -> None:
